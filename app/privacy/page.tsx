    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-gray-700 mb-8 leading-relaxed">
          Your privacy is important to us. This Privacy Policy explains how Universal Converter 
          collects, uses, and protects your information when you use our website and tools.
        </p>
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          <section>
            ...
            <p>
              We may collect basic information such as your name, email address, and any details 
              you provide when contacting us through forms. We also collect anonymous usage data 
              (like search terms and visited pages) to improve our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Our website may use cookies and third-party analytics (such as Google Analytics) to 
              track usage trends. You can disable cookies in your browser settings, but some 
          ...
          <section>
            ...
            <p>
              We do not sell or rent your personal data. We may share information only when 
              required by law or to protect our rights, safety, or security.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              information. However, no online platform can guarantee 100% security.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              contacting us at <span className="font-medium">support@universalconverter.com</span>.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-2">7. Updates to this Policy</h2>
            <p>
