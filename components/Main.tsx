...
//   const [selectedConverter, setSelectedConverter] = useState<Converter | null>(
//     null
//   );
...
//                 className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent outline-none bg-white text-gray-900"
//                 value={searchTerm}
...
//                     className={`flex w-full sm:w-auto text-[10px] sm:text-sm items-center space-x-2 px-4 py-2 rounded-lg transition-all ${
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      try {
        ...
        console.warn("⚠️ AdSense init error:", e);
      }
    }, 1000);
